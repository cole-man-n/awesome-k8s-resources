...
- :green_heart:[hoop.dev](https://github.com/hoophq/hoop):fire::fire::fire: - hoop.dev is an open-source Layer 7 gateway that controls what engineers and AI agents can do inside live sessions to K8s, databases, and infrastructure with data masking, runtime controls, and audit logging.
